    ...
    async def arena_cmd(ack, command, client, respond):
        ...
        if sub == "buy":
            ...
            if item_key not in items:
                await respond("Usage: `/slime_arena buy <might|haste|ward|luck>`"); return
            ...
            if not arg:
                await respond("Usage: `/slime_arena setteam animal1, animal2, ...` (up to 5, comma-separated)"); return
