    ...
    async def quests_cmd(ack, command, client):
        ...
        if action == "claim":
            try:
                ...
                await client.chat_postEphemeral(channel=channel, user=uid, text="usage: `/slime_quests claim <slot>` (1, 2, or 3)"); return
            ...
            msg = (
                ...
                f"{board_text}\n\n_use `/slime_quests claim <slot>` to claim a finished quest_"
            )
